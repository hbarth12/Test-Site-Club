...
window.THURSDAY_CLUB_EVENTS = [
  {
    order: 1,
    date: null,
    displayDate: "Launch date and time · Mazraa",
    title: "Thursday Club Launch",
    guest: "An opening night in Mazraa",
    description: "Food, drinks, conversation, and the beginning of a new gathering place for Syria’s public life.",
    rsvpUrl: "#",
    type: "Launch"
  },
  {
    order: 2,
    date: null,
    displayDate: "Date and time to be announced · Mazraa",
